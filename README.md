Mojo-Webqq v1.7.8 [![Build Status](https://travis-ci.org/sjdy521/Mojo-Webqq.svg?branch=master)](https://travis-ci.org/sjdy521/Mojo-Webqq)
========================
...
``` 
  ...
  ShowQRcode           0        已发布      autodataming  调用系统图片查看程序来示二维码（仅支持Windows/Mac）
