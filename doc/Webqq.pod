...
需要依赖模块 L<Mojo::IRC::Server::Chinese>
    ...
    #以下参数需要 Mojo::IRC::Server::Chinese v1.8.0及以上版本
...
CPAN文档可能比较旧或者表达的信息不够丰富，请参加github上API相关说明L<https://github.com/sjdy521/Mojo-Webqq/API.md>
...
请参加github上API相关说明L<https://github.com/sjdy521/Mojo-Webqq/API.md>
